declare const _default: import("vue").DefineComponent<{
    ...
    inputRef: import("vue").Ref<({
        new (...args: any[]): {
            ...
            } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "readonly" | "error" | "allowClear" | "defaultValue" | "type" | "maxLength" | "showWordLimit">;
            $attrs: {
                [x: string]: unknown;
            };
            $refs: {
            ...
            $emit: ((event: "clear", ev: MouseEvent) => void) & ((event: "change", value: string, ev: Event) => void) & ((event: "focus", ev: FocusEvent) => void) & ((event: "input", value: string, ev: Event) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "pressEnter", ev: KeyboardEvent) => void);
            $el: any;
