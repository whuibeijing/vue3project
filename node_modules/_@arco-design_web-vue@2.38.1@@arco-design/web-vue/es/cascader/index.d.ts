...
declare const Cascader: {
    new (...args: any[]): {
        ...
        $emit: ((event: "clear") => void) & ((event: "change", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "focus", ev: FocusEvent) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "popupVisibleChange", visible: boolean) => void) & ((event: "inputValueChange", value: string) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "search", value: string) => void);
        $el: any;
