...
declare const Statistic: {
    new (...args: any[]): {
        ...
        }> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "format" | "start" | "animation" | "animationDuration" | "precision" | "showGroupSeparator" | "valueFrom">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
