...
declare const Slider: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "defaultValue" | "range" | "modelValue" | "direction" | "max" | "step" | "min" | "showTicks" | "showInput">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
