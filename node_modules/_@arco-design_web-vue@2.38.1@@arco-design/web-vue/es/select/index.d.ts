...
declare const Select: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "error" | "allowClear" | "defaultValue" | "popupVisible" | "defaultPopupVisible" | "unmountOnClose" | "scrollbar" | "multiple" | "loading" | "bordered" | "allowCreate" | "allowSearch" | "maxTagCount" | "defaultInputValue" | "filterOption" | "options" | "searchDelay" | "valueKey" | "defaultActiveFirstOption" | "fallbackOption" | "showExtraOptions" | "limit">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "clear", ev: Event) => void) & ((event: "change", value: string | number | Record<string, any> | (string | number | Record<string, any>)[]) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "popupVisibleChange", visible: boolean) => void) & ((event: "update:inputValue", inputValue: string) => void) & ((event: "inputValueChange", inputValue: string) => void) & ((event: "update:modelValue", value: string | number | Record<string, any> | (string | number | Record<string, any>)[]) => void) & ((event: "remove", removed: string | number | Record<string, any> | undefined) => void) & ((event: "search", inputValue: string) => void) & ((event: "dropdownScroll", ev: Event) => void) & ((event: "dropdownReachBottom", ev: Event) => void) & ((event: "exceedLimit", value: string | number | Record<string, any> | undefined, ev: Event) => void);
        $el: any;
    ...
    Option: import("vue").DefineComponent<{
        value: (StringConstructor | ObjectConstructor | NumberConstructor)[];
