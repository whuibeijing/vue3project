...
var OperationTh = vue.defineComponent({
  ...
  setup(props) {
    ...
    const checkboxStatus = vue.computed(() => {
      ...
      const totalRowNumber = (_b = (_a = tableCtx.currentAllRowKeys) == null ? void 0 : _a.length) != null ? _b : 0;
      ...
      const selectedNumber = ((_f = (_e = tableCtx.currentSelectedRowKeys) == null ? void 0 : _e.length) != null ? _f : 0) - disabledNumber;
      if (selectedNumber > 0) {
