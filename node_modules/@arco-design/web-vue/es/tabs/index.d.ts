...
declare const Tabs: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "trigger" | "position" | "justify" | "type" | "direction" | "animation" | "activeKey" | "defaultActiveKey" | "destroyOnHide" | "editable" | "showAddButton" | "lazyLoad" | "headerPadding" | "autoSwitch" | "hideContent">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "change", key: string | number) => void) & ((event: "add", ev: Event) => void) & ((event: "update:activeKey", key: string | number) => void) & ((event: "delete", key: string | number, ev: Event) => void) & ((event: "tabClick", key: string | number, ev: Event) => void);
        $el: any;
